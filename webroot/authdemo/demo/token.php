...
if (!empty($_REQUEST['code'])&& trim($_REQUEST['code'])!=""){
    ...
    try{
        $result=$oauth_client->getAccessTokenFromCode($_POST['code']);
        echo "换取token成功<br />令牌：".$result['access_token']."<br />有效期：".$result['expires_in']
            ."(".date("Y-m-d H:i:s",time()+$result['expires_in']);
            ."<br />作用域：".$result['scope']
            ."<br />刷新令牌：".$result['refresh_token']
        ;
    ...
    <form name=alipayment action='' method=post target="_blank">
        <div id="body" style="clear:left">
            <dl class="content">
                ...
                <hr class="one_line">
                <dd>
                    <span style="line-height: 28px; color:red;">注意：code由授权页面得到，测试对接案例可尝试手动复制（code时效为5秒）！</span>
                </dd>
                <dt></dt>
                <dd id="btn-dd">
